...
A word (string) of length 0 < str < 1000 (In javascript you may get 
    ...
    cases). You do not need to test for this. This is only here to tell 
...
function getMiddle(s)
{
    ...
    if (s.length % 2 == 0) {
        ...
        result += sArray[middle-1] + sArray[middle];
    }else{
        let middle = s.length / 2 - 0.5;
        result = sArray[middle];
        console.log(middle);
    }
